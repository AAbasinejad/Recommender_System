...
sum_of_AVEARGE_R_PRECISION_for_PERSONAL_recommendation = 0.
...
for index in xrange(1, number_of_training_set_test_set_instances + 1):
	...
	sum_of_R_PRECISION_for_PERSONAL_recommendation = 0.
	...
	for current_user_id in test_graph_users_items['users']:
		...
		current_R_PRECISION_for_PERSONAL_recommendation = homework_2.r_precision(current_user_id, sorted_list_of_recommended_items_form_PERSONAL_recommendation, test_graph_users_items)
		
		sum_of_R_PRECISION_for_PERSONAL_recommendation += current_R_PRECISION_for_PERSONAL_recommendation
	
	print "Current time: " + str(time.asctime(time.localtime()))
	print "Done."

	
	avg_R_PRECISION_for_PERSONAL_recommendation = sum_of_R_PRECISION_for_PERSONAL_recommendation / float(len(test_graph_users_items['users']))
	
	
	sum_of_AVEARGE_R_PRECISION_for_PERSONAL_recommendation += avg_R_PRECISION_for_PERSONAL_recommendation
	


average_R_PRECISION_for_PERSONAL_recommendation_over_all_training_set_test_set_couples = sum_of_AVEARGE_R_PRECISION_for_PERSONAL_recommendation / number_of_training_set_test_set_instances

print
print
print "  average_R_PRECISION_for_PERSONAL_recommendation_over_all_training_set_test_set_couples = " + str(average_R_PRECISION_for_PERSONAL_recommendation_over_all_training_set_test_set_couples)
print
